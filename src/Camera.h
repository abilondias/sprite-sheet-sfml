...
namespace Game {
    class Camera {
    public:
        Camera(Player& p, sf::RenderWindow& w, const float& backgroundWidth); // Player here could be a "Focusable"
    ...
    private:
        ...
        // lowest possible horizontal point so the view doesn't go out of the background's bounds
        ...
        const float maximumViewCenter; // calculated using the specified background's width
    };
} // namespace Game
